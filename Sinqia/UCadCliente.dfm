object frmCadClientes: TfrmCadClientes
  ...
  object dsCadCliente: TDataSource
    ...
    OnStateChange = dsCadClienteStateChange
    Left = 552
    Top = 83
  end
end
